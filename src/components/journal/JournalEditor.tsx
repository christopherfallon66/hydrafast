...
export function JournalEditor({ onSaved, onCancel }: JournalEditorProps) {
  ...
  return (
    <Card>
      <h3 className="text-sm font-bold text-deep-ocean mb-3">New Journal Entry</h3>
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            ...
            <label className="w-20 h-20 rounded-lg border-2 border-dashed border-morning-mist flex items-center justify-center cursor-pointer hover:border-still-water transition-colors">
        ...
        <div className="flex gap-2 pt-2">
          ...
          <Button onClick={handleSave} disabled={!body.trim()} className="flex-1">Save Entry</Button>
        </div>
      </div>
    </Card>
  );
